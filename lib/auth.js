...
async function requireStudent(req, reply) {
  ...
  // Tokens issued before student IDs were required have no student_id; reject
  // them so every message is logged with an ID. The client returns to the join screen on 401.
